...
export default function MealPage({ }) {
  ...
  return (
    <>
      <h1 className="font-bold text-[22px] md:text-3xl py-1 text-center bg-amber-100 flex justify-center items-center text-amber-700">{titulo}<img src="/plato.png" alt="" className="w-10 h-10 mx-3" /></h1>
